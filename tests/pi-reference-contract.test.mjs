...
assert.equal(
  ...
  "node tests/structure.test.mjs && node tests/upstream-sync.test.mjs && node tests/extension.test.mjs && node tests/skill-contracts.test.mjs && node tests/pi-reference-contract.test.mjs && node tests/validate-eval-report.test.mjs && node tests/validate-execution-eval-report.test.mjs && node tests/execution-contracts/run-all.mjs",
);
